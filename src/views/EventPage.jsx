...
import EventMapFrame from '../component/EventMapFrame.jsx';
                                ...
                                <div className="w3-col m12">
                                       <div className="w3-card-2 w3-round w3-white">
                                          <div className="w3-container w3-padding">
                                                ...
                                                <div className="w3-row">
                                                    <a href="javascript:void(0)" onClick={(e) => this.handleClick('Icerik',this).bind(this)}>
                                                ...
                                                <div id="Harita" ref="city" className="w3-container city" >
                                                    <EventMapFrame lat="40.7413232" lon="30.3296314"/>
                                                 </div>
